...
using Specpen.Web.Options;
using Specpen.Web.Scraping;
using Specpen.Web.Services;

namespace Specpen.Tests;

public sealed class SpecpenWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private SqliteConnection? _connection;
    private readonly IReadOnlyDictionary<string, string?> _configurationOverrides;

    public SpecpenWebApplicationFactory()
        : this(null)
    {
    }

    internal SpecpenWebApplicationFactory(IReadOnlyDictionary<string, string?>? configurationOverrides)
    {
