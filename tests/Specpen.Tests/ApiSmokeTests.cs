...
public sealed class ApiSmokeTests(SpecpenWebApplicationFactory factory)
    : IClassFixture<SpecpenWebApplicationFactory>
{
    ...
    {
        await using var staleFactory = new SpecpenWebApplicationFactory(new Dictionary<string, string?>
        {
